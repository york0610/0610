...
export declare const getExtensionModule: (builtPath: string, directory?: string) => Promise<NetlifyExtension<Record<string, unknown>, Record<string, unknown>, Record<string, unknown>>>;
