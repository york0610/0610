...
export { NetlifyExtension, type NetlifyExtensionOptions, } from "./extension/index.js";
...
export type BuildHookWithContext<SiteConfiguration = unknown, TeamConfiguration = unknown, BuildConfiguration = unknown> = (options: {
    buildConfig?: BuildConfiguration;
    client: NetlifyExtensionBuildClient<SiteConfiguration, TeamConfiguration>;
    extensionEndpointFetch: ExtensionEndpointFetch;
} & Omit<NetlifyPluginOptions, "inputs">) => void | Promise<void>;
export type NetlifySDKContext<SiteConfiguration = any, TeamConfiguration = any> = {
    auth: {
    ...
    client: NetlifyExtensionClient<SiteConfiguration, TeamConfiguration>;
    user: {
        id: string | null;
    };
    siteId: string | null;
